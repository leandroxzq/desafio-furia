  ...
  return (
    <div className="flex flex-col rounded-lg px-4 py-8 min-h-[50vh] max-h-[100vh] w-[100%] lg:w-[80%] border-1 border-gray-300 lg:border-0">
      ...
      <form
        ...
        className="bg-gray-50 p-2 2xl:p-4 border-2 border-gray-200 rounded-3xl"
      >
        <div className="flex gap-2 relative h-10 lg:h-25">
          ...
          <ul className="absolute bottom-0 px-2 xl:flex gap-3 hidden">
            {buttons.map((button) => (
              <li
                key={button.text}
                className="bg-black rounded-2xl px-4 py-2 text-white font-bold text-xs lg:text-sm shadow cursor-pointer hover:bg-[#535353]"
